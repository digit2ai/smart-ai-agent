...
try:
    ...
    print("✅ Wake word processor initialized successfully")
except Exception as e:
    print(f"❌ Wake word processor failed: {e}")
    raise

# Initialize service reminder manager
print("🔧 Initializing service reminder manager...")
try:
    service_manager = ServiceReminderManager(service_db, twilio_client, email_client)
    print("✅ Service reminder manager initialized")
except Exception as e:
